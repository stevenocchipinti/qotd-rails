...
describe QuotesController do
  ...
  let(:valid_attributes) { { "quote" => "MyText" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested quote" do
        ...
        Quote.any_instance.should_receive(:update).with({ "quote" => "MyText" })
        put :update, {:id => quote.to_param, :quote => { "quote" => "MyText" }}, valid_session
      end
